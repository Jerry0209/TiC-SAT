...
void test() {
    ...
    printf("Feed forward layer 0: loading weights of feed forward layer (generated by notebook)\n");
    ...
    printf("Feed forward layer 1: loading weights of feed forward layer (generated by notebook)\n");
    ...
    if (!ff0_loaded_from_notebook) {
        printf("Feed forward layer 0: loading weights of feed forward layer (generated by C code)\n");
        loadWeight(n, 1, D_MODEL * D_FF >> 2, ff0_kernel, dir_name);
    }
    if (!ff1_loaded_from_notebook) {
        printf("Feed forward layer 1: loading weights of feed forward layer (generated by C code)\n");
