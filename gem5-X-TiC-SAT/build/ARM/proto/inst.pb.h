...
enum Inst_InstType {
  ...
  Inst_InstType_CusAluProcess = 34,
  Inst_InstType_CusAluQueue = 35,
  Inst_InstType_CusAluParamWrite = 36,
  Inst_InstType_CusMemRead = 37
};
bool Inst_InstType_IsValid(int value);
const Inst_InstType Inst_InstType_InstType_MIN = Inst_InstType_None;
const Inst_InstType Inst_InstType_InstType_MAX = Inst_InstType_CusMemRead;
...
class Inst : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:ProtoMessage.Inst) */ {
 public:
  ...
  static const InstType CusAluProcess =
    Inst_InstType_CusAluProcess;
  static const InstType CusAluQueue =
    Inst_InstType_CusAluQueue;
  static const InstType CusAluParamWrite =
    Inst_InstType_CusAluParamWrite;
  static const InstType CusMemRead =
    Inst_InstType_CusMemRead;
