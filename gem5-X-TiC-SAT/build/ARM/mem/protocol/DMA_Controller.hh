 ...
 *
 * Auto generated C++ code started by /workspace/gem5-X-TiC-SAT/src/mem/slicc/symbols/StateMachine.py:281
...
private:
    ...
    MessageBuffer* m_reqToDir_ptr;
    MessageBuffer* m_respToDir_ptr;
    ...
    void o_checkForCompletion(DMA_TBE*& m_tbe_ptr, Addr addr);
    /** \brief Update ack count */
    void u_updateAckCount(DMA_TBE*& m_tbe_ptr, Addr addr);
    /** \brief send exclusive unblock to directory */
    void u_sendExclusiveUnblockToDir(DMA_TBE*& m_tbe_ptr, Addr addr);
