 ...
 *
 *
 * Auto generated C++ code started by /workspace/gem5-X-TiC-SAT/src/mem/slicc/symbols/Type.py:204
 */
...
(Tick curTime) : Message(curTime) {
        ...
        m_SenderMachine = MachineType_NULL; // default value of MachineType
        ...
        : Message(other)
    {
        ...
        m_SenderMachine = other.m_SenderMachine;
    ...
    ResponseMsg(const Tick curTime, const Addr& local_addr, const CoherenceResponseType& local_Type, const MachineID& local_Sender, const MachineType& local_SenderMachine, const NetDest& local_Destination, const DataBlock& local_DataBlk, const bool& local_Dirty, const int& local_Acks, const MessageSizeType& local_MessageSize)
        : Message(curTime)
    {
        m_addr = local_addr;
        m_Type = local_Type;
        m_Sender = local_Sender;
        m_SenderMachine = local_SenderMachine;
    ...
    /** \brief Const accessor method for SenderMachine field.
     *  \return SenderMachine field
     */
    const MachineType&
    getSenderMachine() const
    {
        return m_SenderMachine;
    }
    ...
    /** \brief Non-const accessor method for SenderMachine field.
     *  \return SenderMachine field
     */
    MachineType&
    getSenderMachine()
    ...
    /** \brief Mutator method for SenderMachine field */
    void
    setSenderMachine(const MachineType& local_SenderMachine)
    {
        m_SenderMachine = local_SenderMachine;
    }
  ...
  //private:
    ...
    MachineID m_Sender;
    /** type of component sending msg */
    MachineType m_SenderMachine;
