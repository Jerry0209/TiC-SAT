...
()
        ...
        m_WaitingUnblocks = 0; // default value of int
    }
        ...
        : AbstractEntry(other)
    {
        ...
        m_WaitingUnblocks = other.m_WaitingUnblocks;
    }
    Directory_Entry(const Directory_State& local_DirectoryState, const NetDest& local_Sharers, const NetDest& local_Owner, const int& local_WaitingUnblocks)
        : AbstractEntry()
    {
        m_DirectoryState = local_DirectoryState;
        m_Sharers = local_Sharers;
        m_Owner = local_Owner;
        m_WaitingUnblocks = local_WaitingUnblocks;
    }
    Directory_Entry*
    clone() const
    {
    ...
    /** \brief Const accessor method for WaitingUnblocks field.
     *  \return WaitingUnblocks field
     */
    const int&
    getWaitingUnblocks() const
    {
        return m_WaitingUnblocks;
    }
    ...
    /** \brief Non-const accessor method for WaitingUnblocks field.
     *  \return WaitingUnblocks field
     */
    int&
    getWaitingUnblocks()
    ...
    /** \brief Mutator method for WaitingUnblocks field */
    void
    setWaitingUnblocks(const int& local_WaitingUnblocks)
    {
        m_WaitingUnblocks = local_WaitingUnblocks;
    }
  ...
  //private:
    ...
    /** Owner of this block */
    NetDest m_Owner;
    /** Number of acks we're waiting for */
    int m_WaitingUnblocks;
};
inline std::ostream&
