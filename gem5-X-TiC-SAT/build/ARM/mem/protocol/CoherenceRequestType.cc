 ...
 *
 * Auto generated C++ code started by /workspace/gem5-X-TiC-SAT/src/mem/slicc/symbols/Type.py:565
 */
...
CoherenceRequestType_to_string(const CoherenceRequestType& obj)
{
    switch(obj) {
      ...
      case CoherenceRequestType_PUTO:
        return "PUTO";
      case CoherenceRequestType_PUTO_SHARERS:
        return "PUTO_SHARERS";
      case CoherenceRequestType_PUTS:
        return "PUTS";
      case CoherenceRequestType_WB_ACK:
        return "WB_ACK";
      case CoherenceRequestType_WB_ACK_DATA:
        return "WB_ACK_DATA";
...
string_to_CoherenceRequestType(const string& str)
{
    if (str == "GETX") {
        ...
        return CoherenceRequestType_PUTO_SHARERS;
    } else if (str == "PUTS") {
        return CoherenceRequestType_PUTS;
    } else if (str == "WB_ACK") {
        return CoherenceRequestType_WB_ACK;
    } else if (str == "WB_ACK_DATA") {
        return CoherenceRequestType_WB_ACK_DATA;
    } else if (str == "WB_NACK") {
