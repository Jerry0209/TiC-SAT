...
SimpleFlag HelloExample("HelloExample", "For Learning gem5 Part 2. Simple example debug flag");
...
SimpleFlag VIOIface("VIOIface", "VirtIO transport");
SimpleFlag VNC("VNC", "None");
SimpleFlag VecRegs("VecRegs", "None");
