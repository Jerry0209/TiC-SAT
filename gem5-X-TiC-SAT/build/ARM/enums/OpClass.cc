...
module_init(py::module &m_internal)
{
    ...
    py::enum_<Enums::OpClass>(m, "enum_OpClass")
        ...
        .value("CusAluProcess", Enums::CusAluProcess)
        .value("CusAluParamWrite", Enums::CusAluParamWrite)
        .value("CusAluQueue", Enums::CusAluQueue)
        .value("CusMemRead", Enums::CusMemRead)
